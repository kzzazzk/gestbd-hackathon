...
def main():
    ...
    dir_cache = os.path.join(script_dir, '../mock_cache')

    # File paths
    file_tematica = os.path.join(dir_cache, 'mock_tematica.csv')
    file_tematica_contenida = os.path.join(dir_cache, 'mock_tematica_contenida.csv')
    file_obra = os.path.join(dir_cache, 'mock_obra.csv')
    file_tecnologia = os.path.join(dir_cache, 'mock_tecnologia.csv')
    file_obra_tecnologia = os.path.join(dir_cache, 'mock_obra_tecnologia.csv')
